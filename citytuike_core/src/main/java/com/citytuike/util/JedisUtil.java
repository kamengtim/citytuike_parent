...
public class JedisUtil {
    ...
    public static void init() {
        ...
        if (jedisPool == null) {
            ...
            config.setMaxIdle(Integer.parseInt(PropertyReader.get("MAX_IDLE")));
            jedisPool = new JedisPool(config, PropertyReader.get("REDIS_IP"), Integer.parseInt(PropertyReader.get("REDIS_PORT")));
        }
    }
    ...
    public class SortSet {
         ...
         *  String
         *            key
         *  int start 开始区间，从0开始(包含)
         *  int end 结束区间,-1为最后一个元素(包含)
         * @return 删除的数量
         * */
